				...
				<div class="py-4">
					<div>
						<div class="flex w-full items-center justify-between">
							<div class="w-full">
								<div class="mt-8 mb-8 space-y-4">
									...
									<p
										class="text-2xl text-neutral-700 dark:text-neutral-400"
									>
										Effortlessly create a PDF from a set of
										selected images through an interfaceless
										system with only the Finder selection
										UI.
									</p>
								</div>
								<div
						...
						<div class="mb-8 w-full space-y-4">
							...
							<p
								class="pb-8 text-2xl text-neutral-700 dark:text-neutral-400"
							>
								Lazy PDF is deliberately designed to be simple
								and have a low overhead, to make it easier to
								grab a set of design files and throw them
								together into a PDF.
							</p>
							<img
						...
						<div class="mb-8 space-y-4">
							...
							<p
								class="pb-8 text-2xl text-neutral-700 dark:text-neutral-400"
							>
								Your logical file order is always respected, so
								number your files if you want to order in
								sequence, otherwise, move them around afterwards
								in any PDF viewer.
							</p>
							<img
								class="dark:ring-2 dark:ring-neutral-800"
						...
						<div class="mb-8 space-y-4">
							...
							<p
								class="pb-8 text-2xl text-neutral-700 dark:text-neutral-400"
							>
								Respecting your image sizes, Lazy PDF doesn't
								try to compress everything to printable sizes,
								ideal for sharing work with teammates and
								management.
							</p>
							<img
								class="dark:ring-2 dark:ring-neutral-800"
						...
						<div class="mb-8 space-y-4">
							...
							<p
								class="pb-8 text-2xl text-neutral-700 dark:text-neutral-400"
							>
								macOS' native 1-click PDF creation (left) pushes
								all files into a printable page collection, Lazy
								PDF (right) leaves your images alone. Perfect
								for long design files such as mobile layouts, or
								ultrawide files when visualising a 21:9 video
								concept.
							</p>
							<img
								class="dark:ring-2 dark:ring-neutral-800"
