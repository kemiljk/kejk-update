<template>
	<div class="relative mx-auto">
		<Nav>
			<NavItem to="/" isActive v-scroll-to="'#HOME'">Home</NavItem>
		...
		<div class="mx-auto max-w-5xl px-4" id="HOME">
			<div>
				<div
					class="text-md pt-4 text-left font-medium uppercase leading-normal tracking-wider text-neutral-600 dark:text-neutral-400 md:pt-24 md:text-center"
				>
			...
			>
				<div>
					...
					>
						Full-time
						<span class="ml-2 font-mono text-teal-500">———</span>
					</div>
					<IconText class="flex items-center">
						...
						<template #text>
							Product Design and Design Systems Lead at
							<a
				...
				<div>
					...
					<IconText class="flex items-center">
						...
						<template #text>
							Leading design for the best API-first headless CMS
							out there at
							<a
					...
					<IconText class="flex items-center">
						...
						<template #text>
							Designing and building powerful business
							technologies with
							<a
			...
			<div class="flex w-full pt-4">
				<div
					class="grid-row xs:grid-cols-1 grid w-full gap-8 sm:grid-cols-2"
				>
