			...
			>
				<label for="bd-email" class="md:col-span-2">
					...
					<input
						...
						class="bg-neutral-100 dark:bg-neutral-800 w-full rounded-lg border border-neutral-200 py-3 px-3 text-neutral-800 focus:outline-none focus:ring-2 focus:ring-teal-500 dark:border-neutral-700 dark:text-neutral-50 active:ring-2 active:ring-teal-500"
						required
					/>
				</label>
